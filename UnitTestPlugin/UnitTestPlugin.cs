    ...
    public class UnitTestPlugin
    {
        ...
        public void UnitTestMethod()
        {
            try
            {
                ...
                Entity targetEntity = new Entity("devops_customentity1");
                targetEntity.LogicalName = "devops_customentity1";
                ...
                pluginContextMock.Setup(t => t.PrimaryEntityName).Returns("devops_customentity1");
                ...
                Assert.AreEqual("Send e-mail to existing customer.", actualEntity["subject"]);
                ...
                Assert.AreEqual("devops_customentity1", actualEntity["category"]);
